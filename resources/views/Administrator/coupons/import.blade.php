...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            ...
            <a href="/Administrator/excel/coupons.xlsx" download="კუპონები" class="btn btn-primary btn-sm pull-right"> 
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    <img src="/Administrator/images/coupons_excel.jpg" style="width: 100%; height: 100%;">
                </p>
            </div>
        </div>
    </div>
