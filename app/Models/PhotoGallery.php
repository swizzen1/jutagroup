...
class PhotoGallery extends Model 
{
    ...
    private static $translates_class = 'App\Models\PhotoGalleryTranslate';
    private static $main_table = 'photo_galleries';
    private static $translates_table = 'photo_gallery_translates';
    private static $gallery_images_table = 'galleries_photos';
    ...
    {
        return $this->hasMany('App\Models\GalleriesPhoto', 'parent_id');
    }
